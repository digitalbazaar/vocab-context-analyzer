...
// `description` documents what a case exercises (e.g. what is broken and which
// rule should catch it); optional and free-form.
const OPTIONAL_STRINGS = ['description', 'labeledBy', 'labeledAt'];
const ALLOWED_KEYS = new Set([
  'name', 'vocab', 'context', 'expectedRuleIds', 'description',
